  ...
  return (
    <div className="max-w-7xl mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Right Column: Pricing and Bidding */}
          ...
          <div className="glass p-8 rounded-3xl border border-white/5 sticky top-24">
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <form action={placeBid} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl py-4 pl-8 pr-4 text-xl font-bold text-white focus:outline-none focus:border-primary transition-colors"
                  />
                </div>
              ...
              <p className="text-xs text-center text-gray-500 mt-4">
                Al enviar una oferta, nuestros agentes negociarán hasta este monto máximo. No cobramos hasta que la oferta sea ganada.
              </p>
            </div>
          </div>
        </div>
